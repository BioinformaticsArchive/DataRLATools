...
# under the License.
# 
# The Original Software is: "C10.py"
# 
...
# =============================================================================
# Start of Febrl project module: "C10.py"
#
# Generated using "guiFebrl.py" on Sat Sep 13 15:48:55 2014
# =============================================================================
...
data_set_a = dataset.DataSetCSV(description="Data set generated by Febrl GUI (note TAB data set is implemented as CSV data set with \t delimiter)",
                                ...
                                miss_val=[''],
                                rec_ident="field-0",
                                file_name="C:\Users\Abdullah\Dropbox\rla\TestData\DataIn10k1.txt",
                                header_line=False,
                                delimiter="\t",
...
data_set_b = dataset.DataSetCSV(description="Data set generated by Febrl GUI (note TAB data set is implemented as CSV data set with \t delimiter)",
                                ...
                                miss_val=[''],
                                rec_ident="field-0",
                                file_name="C:\Users\Abdullah\Dropbox\rla\TestData\DataIn10k2.txt",
                                header_line=False,
                                delimiter="\t",
                                field_list = [("field-0",0),
                                              ("field-1",1),
...
#
index_def_1 = [["field-1", "field-1", False, False, 7, []]]
...
for line in histo_str_list:
  print line
output.SaveMatchStatusFile(class_w_vec_dict, m_set, "C:\Users\Abdullah\Dropbox\rla\TestData\FEBRL\Out10k.txt")


# =============================================================================
# End of Febrl project module: "C10.py"
# =============================================================================
